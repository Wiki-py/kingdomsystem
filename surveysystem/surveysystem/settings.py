...
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', 'localhost,127.0.0.1,kss-1-eja4.onrender.com,kingdomsystem.onrender.com,kingdomsystem-production.up.railway.app').split(',')
